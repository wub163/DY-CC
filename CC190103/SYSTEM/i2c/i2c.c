...
void I2cMaster_Init(void) 
{
  ...
  I2C_InitStructure.I2C_ClockSpeed = I2CSENSORS_SPEED;
...
tryWriteAgain:  
  ret = 0;
  ret = I2C_WriteReg( SENSORS_I2C,slave_addr, reg_addr, len, data_ptr); 
...
tryReadAgain:  
  ret = 0;
  ret = I2C_ReadReg(  SENSORS_I2C,slave_addr, reg_addr, len, data_ptr);
