...
#define sFLASH_CMD_SE             0xD8  /* Sector Erase instruction *///64kblock erase 
...
void sFLASH_EraseSector(uint32_t SectorAddr);//实际清除了一块
void sFLASH_EraseBulk(void);  //全片擦除，需30秒
